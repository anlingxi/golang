...
func NewDeepSeekChatModel(cfg config.EinoConfig) (*DeepSeekChatModel, error) {
...
// 在 deepseek.go 里加这个方法
// EinoModel 返回底层的Eino原生ChatModel，供ADK使用
// EinoModel 暴露底层Eino原生ChatModel，满足ToolCallingChatModel接口
func (m *DeepSeekChatModel) EinoModel() fmodel.ToolCallingChatModel {
	return m.chatModel // *openai.ChatModel 实现了ToolCallingChatModel
}
